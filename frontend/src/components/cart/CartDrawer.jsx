                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6">
                        {cartItems.length === 0 ? (
                            ...
                            cartItems.map((item) => (
                                <div key={item.uid} className="flex gap-4 group">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <button onClick={() => removeFromCart(item.uid)} className="text-slate-300 hover:text-terracotta transition-colors">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center border border-beige-dark/30 rounded-full px-2">
                                                <button onClick={() => updateQuantity(item.uid, -1)} className="p-1 text-slate-400 hover:text-earth">-</button>
